<!-- uploadview/Ruptura.vue -->
<template>
  <div class="upload-container">
    <h2>Enviar Planilha de Auditoria de Ruptura</h2>
    ...
    <div v-if="resposta" class="resposta-container">
      ...
      <div v-else>
        ...
        <p>Total de itens: {{ resposta.totalItens }}</p>

        <button @click="irParaRuptura" class="use-data-btn">
          Ver Relatório de Ruptura
        </button>
      </div>
    </div>
  </div>
...
const irParaRuptura = () => {
  // Você pode criar uma rota para visualizar ruptura depois
  router.push("/ruptura");
};
</script>
