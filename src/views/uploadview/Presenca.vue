<!-- views/uploadview/Presenca.vue - Versão Atualizada -->
<template>
  <div class="upload-container">
    ...
    <div class="loja-info-card">
      ...
      <p class="loja-descricao">
        Envie sua planilha de auditoria de presença para a loja selecionada
      </p>
    </div>
    ...
    <div v-if="resposta" class="resposta-container">
      ...
      <div v-else class="success-card">
        ...
        <div class="success-stats">
          <div class="stat-item">
            <span class="stat-number">{{
              resposta.totalItens || resposta.totalRegistros
            }}</span>
        ...
        <div class="success-actions">
          <button @click="irParaPresenca" class="btn-action primary">
...
const enviarArquivo = async () => {
  ...
  try {
    ...
    console.log(`🏪 Enviando presença para loja: ${lojaStore.codigoLojaAtual}`);

    const { data } = await axios.post(
      "http://localhost:3000/upload-presenca",
      formData,
      {
        headers: {
    ...
    resposta.value = data;
    console.log("✅ Upload de presença realizado:", data);
  } catch (error) {
    console.error("❌ Erro no upload de presença:", error);
...
const irParaPresenca = () => {
  // Redirecionar para onde você quer mostrar os dados de presença
  router.push("/ranking/presenca"); // ou router.push("/presenca")
};
...
<style scoped>
/* Usar os mesmos estilos do Etiqueta.vue */
.upload-container {
  max-width: 800px;
  margin: 0 auto;
  padding: 2rem;
