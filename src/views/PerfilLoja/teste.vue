    ...
    <div class="section-header">
      <div class="summary-cards">
        <div class="summary-card">
          <div class="summary-icon distribuição">
            <img
              src="../../assets/svg/graficoLoja.svg"
              width="35px"
              alt="quantidade de auditorias"
            />
          </div>
        ...
        <div class="summary-card">
          <div class="summary-icon desempenho">
            <img src="../../assets/svg/ranking.png" width="35px" alt="" />
          </div>
          <div class="summary-content">
        ...
        <div class="summary-card">
          <div class="summary-icon setor-destaque">
            <img src="../../assets/svg/trofel.svg" alt="" />
          </div>
          <div class="summary-content">
            <div class="summary-value">Jhon doe</div>
            <div class="summary-label">Colaborador Em Destaque</div>
          </div>
        </div>
        <div class="summary-card">
          <div class="summary-icon tipo-predominante">
            <img src="../../assets/svg/user.svg" width="35px" alt="" />
          </div>
          <div class="summary-content">
